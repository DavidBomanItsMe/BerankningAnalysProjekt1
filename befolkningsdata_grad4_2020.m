...
ANew = [xNew.^4 xNew.^3 xNew.^2 xNew ones(40, 1)];
...
%%%%%%%%%%%
felnorm_Uppsala_G4 = 0;
for K = 1:40
    felnorm_Uppsala_G4 = felnorm_Uppsala_G4 + ((funUppsala(K,1) - y_Uppsala(K,1))^2);
end

felnorm_Uppsala_G4 = sqrt(felnorm_Uppsala_G4);
answer2020_uppsala = polyval(answer1_Uppsala, 120);
%%%%%%%%%%%

felnorm_Jamtland_G4 = 0;
for K = 1:40
    felnorm_Jamtland_G4 = felnorm_Jamtland_G4 + ((funJamtland(K,1) - y_Jamtland(K,1))^2);
end

felnorm_Jamtland_G4 = sqrt(felnorm_Jamtland_G4);
answer2020_jamtland = polyval(answer1_Jamtland, 120);