...
felnorm_Uppsala_G2 = 0;
for K = 1:40
    felnorm_Uppsala_G2 = felnorm_Uppsala_G2 + ((funUppsala(K,1) - y_Uppsala(K,1))^2);
end

felnorm_Uppsala_G2 = sqrt(felnorm_Uppsala_G2);


felnorm_Jamtland_G2 = 0;
for K = 1:40
    felnorm_Jamtland_G2 = felnorm_Jamtland_G2 + ((funJamtland(K,1) - y_Jamtland(K,1))^2);
end

felnorm_Jamtland_G2 = sqrt(felnorm_Jamtland_G2);
